...
import { renderMessageMedia } from './scripts/message-media-renderer.js';
...
export function appendMediaToMessage(mes, messageElement, adjustScroll = true) {
    ...
    renderMessageMedia({ message: mes, messageElement, media, adjustScroll });
}
...
export function addCopyToCodeBlocks(messageElement) {
    return addCopyToCodeBlocksCore(messageElement);
}
...
export function getCharacterAvatar(characterId) {
    return getCharacterAvatarCore(characterId);
}

export function formatCharacterAvatar(characterAvatar) {
    return formatCharacterAvatarCore(characterAvatar);
}
...
export async function unshallowCharacter(characterId) {
    return unshallowCharacterCore(characterId);
}
